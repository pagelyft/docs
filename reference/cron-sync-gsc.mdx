---
title: "Cron: Sync GSC"
description: "Technical reference for the twice-daily Google Search Console data sync job at /api/cron/sync-gsc."
---
...
**Schedule:** Twice daily at 7:30 AM and 7:30 PM UTC (`30 7 * * *` and `30 19 * * *`)
