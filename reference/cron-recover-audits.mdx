...
description: "Technical reference for the recurring stuck audit recovery job at /api/cron/recover-audits."
---
...
- **If still crawling** — the audit is skipped and left in `"crawling"` status. It will be checked again on the next run.
